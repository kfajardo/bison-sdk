...
export declare const ONBOARDING_STEPS: readonly OnboardingStep[];
...
export type OnboardingSubmit = {
    ...
    existingMappings?: {
        externalRepresentativeId: string;
        index: number;
    }[];
} | {
    step: 'volume';
    data: ProcessingVolumePayload;
};
...
export type MoovFilePurpose = 'merchant_underwriting' | 'identity_verification' | 'individual_verification' | 'representative_verification' | 'account_requirement' | 'business_verification';
